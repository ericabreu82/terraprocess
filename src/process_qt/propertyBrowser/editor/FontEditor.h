...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_FONT_EDITOR__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_FONT_EDITOR__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT FontEditor : public QWidget, public AbstractEditor
      {
