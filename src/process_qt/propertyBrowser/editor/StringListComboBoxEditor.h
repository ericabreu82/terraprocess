...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLIST_COMBOBOX_EDITOR__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLIST_COMBOBOX_EDITOR__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT StringListComboBoxEditor : public QComboBox, public AbstractEditor
      {
      ...
      protected:
        ...
        virtual void addComboOptions(const std::vector<tr::processQt::propertyBrowser::Variant>& options);
      };
    }
  }
}
