...
/*!
  \file StringListComboBoxEditorFactory.cpp

  \brief This is the concrete factory for editors.
*/

// TerraLib
#include "src/process_qt/propertyBrowser/factory/editor/StringListComboBoxEditorFactory.h"
...
tr::processQt::propertyBrowser::AbstractEditor* tr::processQt::propertyBrowser::StringListComboBoxEditorFactory::build(EditorFactoryParamsCreate params)
{
...
tr::processQt::propertyBrowser::StringListComboBoxEditorFactory::StringListComboBoxEditorFactory() :
