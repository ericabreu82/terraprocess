...
/*!
  \file BoolCheckBoxEditorFactory.h

  \brief This is the concrete factory for create editors.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_BOOL_CHECKBOX_EDITOR_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_BOOL_CHECKBOX_EDITOR_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      /*!
        \class BoolCheckBoxEditorFactory

        \brief This is the concrete factory for create editors.

        \sa EditorFactory, ParameterizedAbstractFactory, AbstractEditor
      */
      class TERRAPROCESSQTEXPORT BoolCheckBoxEditorFactory : public EditorFactory
      {
      public:
