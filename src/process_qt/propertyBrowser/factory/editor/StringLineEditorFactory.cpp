...
/*!
  \file StringLineEditorFactory.cpp

  \brief This is the concrete factory for editors.
*/

// TerraLib
#include "src/process_qt/propertyBrowser/factory/editor/StringLineEditorFactory.h"
#include "src/process_qt/propertyBrowser/enum/Enums.h"
#include "src/process_qt/propertyBrowser/editor/StringLineEditor.h"

tr::processQt::propertyBrowser::AbstractEditor* tr::processQt::propertyBrowser::StringLineEditorFactory::build(EditorFactoryParamsCreate params)
{
...
tr::processQt::propertyBrowser::StringLineEditorFactory::StringLineEditorFactory() :
