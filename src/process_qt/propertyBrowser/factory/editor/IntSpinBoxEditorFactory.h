...
/*!
  \file IntSpinBoxEditorFactory.h

  \brief This is the concrete factory for create editors.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_INTSPINBOX_EDITOR_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_INTSPINBOX_EDITOR_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      */
      class TERRAPROCESSQTEXPORT IntSpinBoxEditorFactory : public EditorFactory
      {
      public:
