...
/*!
  \file StringListComboBoxRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLIST_COMBOBOX_RENDER_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLIST_COMBOBOX_RENDER_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      */
      class TERRAPROCESSQTEXPORT StringListComboBoxRenderFactory : public RenderFactory
      {
      public:
