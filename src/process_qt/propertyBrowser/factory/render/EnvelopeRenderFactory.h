...
/*!
  \file EnvelopeRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_ENVELOPE_RENDER_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_ENVELOPE_RENDER_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      */
      class TERRAPROCESSQTEXPORT EnvelopeRenderFactory : public RenderFactory
      {
      public:
