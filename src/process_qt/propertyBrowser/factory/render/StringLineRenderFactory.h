...
/*!
  \file StringLineRenderFactory.h

  \brief This is the concrete factory for create render.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLINE_RENDER_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLINE_RENDER_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      */
      class TERRAPROCESSQTEXPORT StringLineRenderFactory : public RenderFactory
      {
      public:
