...
/*!
  \file DoubleSpinBoxRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_DOUBLE_SPINBOX_RENDER_FACTORY__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_DOUBLE_SPINBOX_RENDER_FACTORY__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      */
      class TERRAPROCESSQTEXPORT DoubleSpinBoxRenderFactory : public RenderFactory
      {
      public:
