...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_COLOR_RENDER__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_COLOR_RENDER__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT ColorRender : public AbstractRender
      {
      public:
