...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_BUILD_RENDER__
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_BUILD_RENDER__
  ...
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \brief
        ...
        \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT BuildRender
      {
      public:
        /*!
          \brief Constructor
