...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLINE_RENDER__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_STRINGLINE_RENDER__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT StringLineRender : public AbstractRender
      {
      public:
