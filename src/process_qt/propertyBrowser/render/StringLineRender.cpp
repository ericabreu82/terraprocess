...
tr::processQt::propertyBrowser::StringLineRender::StringLineRender()
{
...
void tr::processQt::propertyBrowser::StringLineRender::render(QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index)
{
