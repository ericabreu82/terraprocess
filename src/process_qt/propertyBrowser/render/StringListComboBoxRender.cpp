...
tr::processQt::propertyBrowser::StringListComboBoxRender::StringListComboBoxRender()
{
...
void tr::processQt::propertyBrowser::StringListComboBoxRender::render(QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index)
{
