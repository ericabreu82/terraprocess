...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_FONT_RENDER__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_FONT_RENDER__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT FontRender : public AbstractRender
      {
      public:
