...
tr::processQt::propertyBrowser::ColorRender::ColorRender()
{
...
void tr::processQt::propertyBrowser::ColorRender::render(QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index)
{
