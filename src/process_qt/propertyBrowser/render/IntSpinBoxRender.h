...
#ifndef __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_INTSPIN_BOXRENDER__ 
#define __TERRAPROCESS_PROCESSQT_PROPERTYBROWSER_INTSPIN_BOXRENDER__
...
namespace tr
{
  namespace processQt
  {
    namespace propertyBrowser
    {
      ...
      \ingroup propertyBrowser
      */
      class TERRAPROCESSQTEXPORT IntSpinBoxRender : public AbstractRender
      {
      public:
